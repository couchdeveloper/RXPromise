Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/lkoskela/RXPromise"
  s.source           = { :git => "https://github.com/lkoskela/RXPromise.git", :tag => s.version.to_s }
  ...
  s.public_header_files = "Source/RXPromiseForAll.h", "Source/RXPromiseHeader.h", "Source/RXPromise+RXExtension.h", "Source/RXSettledResult.h"
